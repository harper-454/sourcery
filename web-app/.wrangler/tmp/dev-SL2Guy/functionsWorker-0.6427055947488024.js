...
// .wrangler/tmp/pages-QOobjB/functionsWorker-0.6427055947488024.mjs
...
function handleHostConnection(ws, room) {
  ...
  if (!roomData) {
    roomData = { host: null, clients: /* @__PURE__ */ new Set() };
...
__name(handleHostConnection, "handleHostConnection");
__name2(handleHostConnection, "handleHostConnection");
...
__name(handleClientConnection, "handleClientConnection");
__name2(handleClientConnection, "handleClientConnection");
var routes = [
  {
    routePath: "/stream",
    mountPath: "/",
...
// .wrangler/tmp/bundle-EaHAO5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EaHAO5/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6427055947488024.js.map
